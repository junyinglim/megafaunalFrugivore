...
med_levels <- c("(Intercept)", "curr_logMedBS_scl","pnat_logMedBS_scl", "pnat_logMedBS_cons_scl", "pnat_logMedBS_supercons_scl","globalPC1_scl", "globalPC2_scl","globalPC3_scl", "regionalPC1_scl","regionalPC2_scl", "regionalPC3_scl","lgm_ens_Pano_scl", "lgm_ens_Tano_scl")
...
max_levels <- c("(Intercept)", "curr_logMax95BS_scl","pnat_logMax95BS_scl", "pnat_logMax95BS_cons_scl", "pnat_logMax95BS_supercons_scl", "globalPC1_scl", "globalPC2_scl","globalPC3_scl", "regionalPC1_scl","regionalPC2_scl", "regionalPC3_scl","lgm_ens_Pano_scl", "lgm_ens_Tano_scl")
...
medBS_ols_modavg <- subset(medBS_ols_modavg, !coefficient == "(Intercept)")
...
medBS_ols_cade_modavg <- subset(medBS_ols_cade_modavg, !coefficient == "(Intercept)")
...
maxBS_ols_modavg <- subset(maxBS_ols_modavg, !coefficient == "(Intercept)")
...
maxBS_ols_cade_modavg <- subset(maxBS_ols_cade_modavg, !coefficient == "(Intercept)")
